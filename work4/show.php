...
?>
  <tr>
    ...
    <td><a type="button" class="btn btn-warning" href="edit_form.php?name=<?php echo $Result['Name', 'Comment', 'Link']?>">EDIT</a><a type="button" class="btn btn-danger" href="delete.php?name=<?php echo $Result['Name', 'Comment', 'Link']?>">DELETE</a></td>
  </tr>
<?php
}
?>
