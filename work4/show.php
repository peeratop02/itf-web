...
?>
  <tr>
    ...
    <td><a type="button" class="btn btn-primary" href="delete.php?name=<?php echo $Result['Name']?>">DELETE</a><a type="button" class="btn btn-primary" href="edit.php?name=<?php echo $Result['Name']?>">EDIT</a></td>
  </tr>
<?php
}
?>
