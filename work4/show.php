...
?>
  <tr>
    ...
    <td><a type="button" class="btn btn-warning" href="edit_form.php?name=<?php echo $Result['Name']?>">EDIT</a><a type="button" class="btn btn-danger" href="delete.php?name=<?php echo $Result['Name']?>">DELETE</a></td>
  </tr>
<?php
}
?>
