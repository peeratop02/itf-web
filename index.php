...
<body id="page-top">
    <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-secondary text-uppercase" id="mainNav">
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">Peerawit itf</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" aria-controls="navbarResponsive"
    ...
    <header class="masthead bg-primary text-white text-center" style="padding-bottom: 56px;padding-top: 119px;"><img class="img-fluid d-block mx-auto mb-5" src="assets/img/b4f9a703222d96c5ed72ac1b94aeca4e.png" style="height: 317px;margin: -20px;margin-bottom: 0px;margin-left: 201px;">
        <div class="container">
            <h1 style="margin: 0;margin-top: -33px;">Hej!</h1>
            <hr class="star-light">
            <h2 class="font-weight-light mb-0">You can open my work by choosing from drop-down icon or scroll down below. Enjoy!</h2>
        </div>
    </header>
    <section id="portfolio" class="portfolio">
        <div class="container">
            ...
            <div class="col" style="padding-bottom: 10;">
                <div class="card">
                    <div class="card-body">
                        <h3 class="text-center card-title"><a href="work1/index.php">Funny Story</a></h3>
                        <h6 class="text-center text-secondary card-subtitle mb-2">LAB 11 Assignment</h6>
                    </div>
                </div>
            </div>
            <div class="col" style="margin-top: 15px;">
                <div class="card">
                    <div class="card-body">
                        <h3 class="text-center card-title"><a href="work2/index.html">Layout Design</a></h3>
                        <h6 class="text-center text-secondary card-subtitle mb-2">LAB 12 Assignment #1</h6>
                    </div>
                </div>
            </div>
            <div class="col" style="margin-top: 15px;">
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small>Copyright ©&nbsp;PeeraStudio 2020</small></div>
    </div>
